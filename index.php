...
$(function() {
    ...
    $(".remover").live("click", ".remove", function(e) { 
 ...
 <div class="col-md-4 order-md-2 mb-4">
	...
	-->
	  ...
	  <form class="needs-validation" action="upload.php" method="post"  id="myform" novalidate enctype="multipart/form-data">
      <div id="firstrow">
        <div class="row">
    ...
    <div id="container"/>
		...
		<div><a href="#" id="addnew">Add New Person</a></div>
    ...
    <div>
		...
		<button class="btn btn-primary btn-lg btn-block" type="submit" name="uploadBtn" value="Upload" >Send Mail / Envoyer l Email / تنزيل</button>
      </form>
  ...
  <footer class="my-5 pt-5 text-muted text-center text-small">
    ...
    <ul class="list-inline">
	  ...
	  <li class="list-inline-item"><a href="mailto:naanaasabri@gmail.com?subject=FP reneignements&body=Bonjour">Click Here if you wanna mail us</a></li>
